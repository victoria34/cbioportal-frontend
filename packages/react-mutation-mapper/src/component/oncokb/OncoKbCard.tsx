                            ...
                            <span>
                                <div className={tabsStyles["tabs-wrapper"]}>
                                    ...
                                    {this.activeTab === "mutationEffect" &&
                                        ...
                                        >
                                        {this.props.biologicalSummary !== undefined &&  this.props.biologicalSummary.length > 0 ?
                                            <SummaryWithRefs
                                                content={this.props.biologicalSummary}
                                                type={'tooltip'}
                                                pmidData={this.props.pmidData!}
                                            /> :
                                            (this.props.mutationEffectCitations && (this.props.mutationEffectCitations.abstracts.length > 0 || this.props.mutationEffectCitations.pmids.length > 0) ?
                                                <ReferenceList
                                                    pmidData={this.props.pmidData}
                                    ...
                                    <Collapse isOpened={!this.levelsCollapsed}>
                                        <div className={classnames(levelStyles.levels, collapsibleStyles["levels-collapse"])}>
                                            <ul style={{lineHeight: 8, padding: 0}}>
                                                {this.generateLevelRows(OncoKbHelper.LEVELS, OncoKbHelper.LEVEL_DESC)}
                                            </ul>
                                        </div>
                                    </Collapse>
                                </div>

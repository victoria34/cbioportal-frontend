...
import {SimpleCopyDownloadControls} from "./SimpleCopyDownloadControls";
            ...
            <tr>
                ...
                <td>
                    <a onClick={handleTabDelimitedDownload}>
                        <i className='fa fa-cloud-download'/> Tab Delimited Format
                    </a>
                    <span style={{margin:'0px 10px'}}>|</span>
                    <a onClick={handleTransposedMatrixDownload}>
                        <i className='fa fa-cloud-download'/> Transposed Matrix
                    </a>
                </td>
            </tr>
        );
                                    ...
                                    filename: string)
    {
        return (
            <tr>
                <td>{title}</td>
                <td>
                    <SimpleCopyDownloadControls downloadData={handleDownload} downloadFilename={filename} />
                </td>
            </tr>
        );
    }
